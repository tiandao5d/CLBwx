package com.genlot.ushop.api.merchant.interceptor;
...
public class OAuthInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		try
		{
			...
			{
				log.error("Token time is illegal,userNo[{}] diff[{}] !", userNo, diff);
			...
			{
				log.error("Token user is illegal,userNo[{}] userNo[{}] token[{}] !", userNo, token.getUserNo(), token.getTokenId());
			...
			{
				log.error("Token sign is illegal,userNo[{}] clientSign[{}] serverSign[{}] !", userNo, clientSign, serverSign);
				throw OAuthBizException.OAUTH_TOKEN_INVALID;
			}
			return true;
		}
